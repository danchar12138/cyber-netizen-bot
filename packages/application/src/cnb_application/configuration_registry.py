...
def build_default_registry() -> ConfigurationRegistry:
    ...
    return ConfigurationRegistry(
        (
            ...
            ConfigDefinition(
                key="alerts.recommendation.calibration.window_days",
                section="observability",
                label="建议校准分析窗口",
                description="离线阈值校准读取最近多少天的冻结人工反馈。",
                value_kind=ConfigValueKind.INTEGER,
                default=30,
                scopes=per_agent,
                minimum=7,
            ...
            ConfigDefinition(
                ...
                section="observability",
                label="建议校准每组最小样本",
                description="分组反馈达到该数量后才允许提出离线阈值变更建议。",
                value_kind=ConfigValueKind.INTEGER,
                default=20,
                scopes=per_agent,
                minimum=5,
            ...
            ConfigDefinition(
                ...
                section="observability",
                label="建议校准目标采纳率",
                description="Wilson 置信区间与该目标比较，仅用于离线决策支持。",
                value_kind=ConfigValueKind.NUMBER,
                default=70.0,
                scopes=per_agent,
                minimum=50,
