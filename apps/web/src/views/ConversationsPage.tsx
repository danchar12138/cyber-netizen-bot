...
import { Archive, MessageSquareText, Pencil, Pin, RotateCcw, Trash2 } from 'lucide-react'
...
export function ConversationsPage() {
  ...
  const conversations = useQuery({
    queryKey: ['managed-conversations', statusFilter],
    queryFn: () => getConversations('', statusFilter === 'all' ? undefined : statusFilter),
  })
  const refresh = () => queryClient.invalidateQueries({ queryKey: ['managed-conversations'] })
