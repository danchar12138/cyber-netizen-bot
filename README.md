...
最新开发计划见 [`docs/plans/2026-09-15-v43.md`](docs/plans/2026-09-15-v43.md)。原始范围见 [`docs/plans/2026-09-09-v2.md`](docs/plans/2026-09-09-v2.md)，MinIO 唯一对象存储修订与 P0 至 P7 完成清单见 [`docs/plans/2026-09-09-v3.md`](docs/plans/2026-09-09-v3.md)。GitHub `main` 分支保护仍受私有仓库套餐能力限制，仓库内功能与质量门禁不受影响。
