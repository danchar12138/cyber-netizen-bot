...
当前已完成 P1、P2、P3、P4、P5，下一阶段是 P6 多模态与 Channel Adapter；P0 的代码基线已具备，Docker 实跑与分支保护仍待环境验证。最新开发计划见 [`docs/plans/2026-09-09-v3.md`](docs/plans/2026-09-09-v3.md)。
...
- Alembic 配置、对话、附件、加密密钥、审计、认知运行、长期记忆和可靠异步任务迁移，当前 head 为 `20260910_0009`。
...
主动行为默认关闭。启用后仍会在执行时按最新配置重新检查评分阈值、安静时段、用户近期活跃度、关系边界和每日社交预算；P6 将在这一确定性策略边界之后接入正式 Web Channel Adapter。
